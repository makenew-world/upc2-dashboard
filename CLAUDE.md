...
## ⚠️ ข้อจำกัดสำคัญ: ยอดวันสุดท้ายของเดือนมักหลุด

ไฟล์ SD0002 มีข้อมูล **เฉพาะเดือนปัจจุบัน** และยอดบิลขึ้นช้าประมาณ 1 วัน
→ พอโหลดไฟล์วันที่ 1 ของเดือนใหม่ จะได้แต่เดือนใหม่ **ยอดวันสุดท้ายของเดือนก่อนจึงหลุดตลอด**

ที่เคยหลุดมาแล้ว: 31 ก.ค. 2569 และ 31 ส.ค. 2569 (ทั้งคู่เป็นวันทำการ และยอดสิ้นเดือนมักสูง)
ทำให้ `QUARTER_PREV_ACT` ต่ำกว่าจริง → การ์ด Q3 และ Q3 ในทุก Area แสดงเปอร์เซ็นต์ต่ำกว่าความจริง

**วิธีเลี่ยง:** โหลด SD0002 อีกครั้ง **หลังวันสุดท้ายของเดือน 1–2 วัน โดยเลือกช่วงวันที่ย้อนหลัง**
(ถ้าระบบเลือกช่วงวันที่ได้) แล้วรัน `update.py` กับไฟล์นั้นเพื่อเก็บยอดเต็มเดือนก่อนขึ้นเดือนใหม่

**สำคัญมาก:** 30 ก.ย. 2569 = วันปิด Q3 ถ้ายอดวันนั้นหลุด ตัวเลข Q3 สุดท้าย (ที่ใช้คิด incentive) จะผิด
